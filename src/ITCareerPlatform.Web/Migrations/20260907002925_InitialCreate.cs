        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GithubUrl = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    LinkedInUrl = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    PortfolioUrl = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    TechSkillTags = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ...
                    CvContentType = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechStack = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CvFileNameSnapshot = table.Column<string>(type: "nvarchar(260)", maxLength: 260, nullable: false),
                    CvDataSnapshot = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    CvContentTypeSnapshot = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    AppliedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AiScore = table.Column<int>(type: "int", nullable: true),
                    AiStrengths = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    AiMissing = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    AiRoadmap = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    AiSource = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    AiScoredAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    HrScore = table.Column<int>(type: "int", nullable: true),
                    HrNote = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    HrAdjustedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Quản trị toàn hệ thống IT Career Platform", "Admin" },
                    { 2, "Cố vấn tuyển dụng IT — đăng việc, xem hồ sơ SV", "Mentor" },
                    { 3, "Sinh viên IT sắp tốt nghiệp — tìm việc, tạo hồ sơ, ứng tuyển", "SinhVienIT" }
                });
